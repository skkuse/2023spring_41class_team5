...
--
-- Host: skkuse.coeckcs1kf9q.ap-northeast-2.rds.amazonaws.com    Database: test
-- ------------------------------------------------------
...
CREATE TABLE `feedback` (
  ...
  `prompt` varchar(5000) DEFAULT NULL,
...
CREATE TABLE `problem` (
  ...
  `test_case` varchar(500) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2023-06-14 15:24:41
